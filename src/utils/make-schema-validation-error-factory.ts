...
export function makeSchemaValidationErrorFactory(ctor: TConstructible<RestError>): TSchemaValidationErrorFactory<RestError> {
  return function (ajvError: ErrorObject, data: any): RestError {
