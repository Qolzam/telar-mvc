...
export function before(middleware: Router.Middleware<any, {}>): any {
  return function (target: any, key?: string, descriptor?: PropertyDescriptor) {
    if (isClassDecorator(target, arguments)) {
      ...
      Reflect.defineMetadata(MetadataKey.ROUTE_BEFORE_MIDDLEWARES, middlewares.concat({ isFactory: false, factoryOrHandler: middleware as Router.Middleware<any, {}> }), target, key as string);
    } else {
